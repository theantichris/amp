...
Route::group(
    ...
    function () {
            ...
            function () {
                Route::group(
                    ...
                    function () {
                        ...
                        Route::delete('/{id}', 'Project\Material\MaterialApiController@delete');
                    }
                );

                Route::group(
                    ['prefix' => '{projectId}/parts'],
                    function () {
        ...
        Route::group(
            ['prefix' => 'deleted'],
            function () {
                Route::put('/projects/materials/{id}', 'Project\Material\MaterialApiController@restore');
            }
        );
